    ...
    def get_context_data(self, **kwargs):
        ...
        for subject in Subject.objects.all():
            question_count = Question.objects.filter(
                quiz__category__subject=subject
            ).count()
...
def add_question(request):
    if request.method == "POST":
        ...
        if question_form.is_valid():
            ...
            return redirect(
                "subject-list"
            )  # Redirect to the question list page or success page
        else:
...
def create_category(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                "create_quiz"
            )  # Redirect to a category listing page or success page
    else:
        form = CategoryForm()
...
def create_quiz(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                "add_question"
            )  # Redirect to a quiz listing page or success page
    else:
        form = QuizForm()
